...
public class ProdutoController {
	...
	public ResponseEntity<ProdutoVO> createProduto(ProdutoVO produtoVO){
		ProdutoVO produtoVORetorno = produtoService.create(produtoVO);
		return ResponseEntity.ok(produtoVORetorno);
	}
}
